    ...
    <div style={{ paddingTop: 46, backgroundColor: '#f7f7f7', minHeight: '100vh', fontFamily: 'Montserrat, Arial, sans-serif' }}>
      ...
      <div style={{ backgroundColor: '#f7f7f7', padding: '40px 0' }}>
        <div style={{ maxWidth: 970, margin: '0 auto', padding: '0 20px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 20 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                  <a href="https://www.barnesandnoble.com/w/entrepreneurs-guide-to-the-lean-brand-jeremiah-gardner/1120544524?ean=9780996100748" target="_blank" rel="noopener" style={{ display: 'inline-block', padding: '10px 20px', backgroundColor: '#ff8000', color: '#fff', fontFamily: 'Montserrat, Arial, sans-serif', fontSize: 12, textTransform: 'uppercase', textDecoration: 'none' }}>Barnes &amp; Noble</a>
                  <a href="https://www.amazon.com/Entrepreneurs-Guide-Lean-Brand-Gardner/dp/0996100746" target="_blank" rel="noopener" style={{ display: 'inline-block', padding: '10px 20px', backgroundColor: '#ff8000', color: '#fff', fontFamily: 'Montserrat, Arial, sans-serif', fontSize: 12, textTransform: 'uppercase', textDecoration: 'none' }}>Amazon</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ backgroundColor: '#fff', border: '1px solid #ccc', padding: 30, marginBottom: 20 }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 20 }}>
              <div style={{ width: 140, height: 180, backgroundColor: '#f93', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                  <a href="https://www.amazon.com/Entrepreneurs-Guide-Lean-Brand-Gardner/dp/B01Jxt3YGU" target="_blank" rel="noopener" style={{ display: 'inline-block', padding: '10px 20px', backgroundColor: '#ff8000', color: '#fff', fontFamily: 'Montserrat, Arial, sans-serif', fontSize: 12, textTransform: 'uppercase', textDecoration: 'none' }}>Amazon Kindle</a>
      ...
      {/* FOOTER */}
      <footer style={{ textAlign: 'center', backgroundColor: '#eee', paddingTop: 10, paddingBottom: 30, marginTop: 60 }}>
