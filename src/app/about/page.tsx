    ...
    <div style={{ backgroundColor: '#f7f7f7', minHeight: '100vh', fontFamily: 'Montserrat, Arial, sans-serif' }}>
      ...
      <section style={{ backgroundColor: '#fff', padding: '40px 0', borderBottom: '1px solid #D8D3CC' }}>
        <div style={{ maxWidth: 970, margin: '0 auto', padding: '0 20px' }}>
          <h1 style={{ color: '#343434', fontSize: 40, fontWeight: 'normal', textTransform: 'uppercase', marginBottom: 20, fontFamily: 'Montserrat, Arial, sans-serif' }}>About the Book</h1>
          <h3 style={{ color: '#343434', fontSize: 22, fontWeight: 'normal', lineHeight: 1.4, marginBottom: 15, fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif' }}>
      ...
      <section style={{ backgroundColor: '#f7f7f7', padding: '40px 0', borderBottom: '1px solid #D8D3CC' }}>
        <div style={{ maxWidth: 970, margin: '0 auto', padding: '0 20px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', marginTop: 30 }}>
            {/* Phase 1 */}
            <div style={{ flex: '0 0 25%', boxSizing: 'border-box', padding: '0 10px' }}>
        ...
        <div style={{ maxWidth: 970, margin: '0 auto', padding: '0 20px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            {[
              ...
              <div key={i} style={{ flex: '0 0 33.333%', boxSizing: 'border-box', padding: '0 15px', marginBottom: 30 }}>
        ...
        <div style={{ maxWidth: 970, margin: '0 auto', padding: '0 20px' }}>
          ...
          <div>
            {[
              ...
              <a key={href} href={href} style={{ display: 'block', color: '#666', fontSize: 16, lineHeight: 1.6, fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif', marginBottom: 12, textDecoration: 'none' }}>
                {title}
              </a>
            ))}
          </div>
